...
export default function MobileNav({ showNav, closeNav }: MobileNavProps) {
  ...
  return (
    <div className={`fixed inset-0 transition-all duration-300 h-[100vh] bg-[#000000e0] z-[1002] ${navStyle}`}>
      <ImCross onClick={closeNav} className="absolute top-[2rem] right-[2rem] w-[2rem] h-[2rem] text-white" />

      <div className={`bg-emerald-700 transition-all duration-300 delay-200 flex flex-col items-center justify-center w-[70%] h-[100%] ${navStyle}`}>
